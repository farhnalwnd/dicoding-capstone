...
async def list_users(
    role: Optional[str] = Query(None, description="Filter by role: hr, jobseeker, admin"),
    ...
    return admin_service.get_all_users(role=role, status=status, search=search, skip=skip, limit=limit)
